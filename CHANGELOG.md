...
- Add `tab.expect_request` and `tab.expect_response` method for wait request and response @3mora2
- Add `tab.wait_for_ready_state` method for wait page to load @3mora2
